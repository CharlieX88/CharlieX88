...
🔭 I'm currently working on Full-stack applications using the MERN stack, while sharpening my DSA fundamentals in Java for interview prep and competitive problem-solving.

👯 I'm looking to collaborate on Open-source projects that go beyond good-first-issues — things involving real architecture decisions, API design, or scaling a codebase with other contributors.

🤝 I'm looking for help with Advanced problem-solving patterns, writing production-grade clean code, and understanding system design at scale.

🌱 I'm currently learning Advanced DSA, system design fundamentals, and contributing meaningfully to larger open-source codebases (not just README fixes).
